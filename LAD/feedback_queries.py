task0_feedback = """SELECT (team_id) AS Entries,"Task 0" AS taskName, theme,
                case 
...
task1_feedback = """SELECT (tf1.team_id) AS Entries,"Task 1" AS taskName, tf1.theme,
                case 
...
task2_feedback = """SELECT (tf2.team_id) AS Entries,"Task 2" AS taskName, tf2.theme,
                case 
...
task3_feedback = """SELECT (tf3.team_id) AS Entries,"Task 3" AS taskName, tf3.theme,
                case 
...
task4_feedback = """SELECT (tf4.team_id) AS Entries,"Task 4" AS taskName,tf4.theme,
                case 
...
task5_feedback = """SELECT (tf5.team_id) AS Entries,"Task 5" AS taskName, tf5.theme,
                case 
...
stage1_part1 = """SELECT (s1.team_id) AS Entries,"Stage1_feedback_P1" AS taskName, s1.theme,
case 
...
stage1_part2 = """SELECT (s1.team_id) AS Entries,"Stage1_feedback_P2" AS taskName, s1.theme,
case 
...
stage1_part3 = """SELECT (s1.team_id) AS Entries,"Stage1_feedback_P3" AS taskName, s1.theme,
case 
...
stage1_part4 = """SELECT (s1.team_id) AS Entries,"Stage1_feedback_P4" AS taskName, s1.theme,
case 
...
stage2_part1 = """SELECT (s2.team_id) AS Entries,"Stage2_feedback_P1" AS taskName, s2.theme,
case 
...
stage2_part2 = """SELECT (s2.team_id) AS Entries,"Stage2_feedback_P2" AS taskName, s2.theme,
case 
...
stage2_part3 = """SELECT (s2.team_id) AS Entries,"Stage2_feedback_P3" AS taskName, s2.theme,
case 
...
stage2_part4 = """SELECT (s2.team_id) AS Entries,"Stage2_feedback_P4" AS taskName, s2.theme,
case 
